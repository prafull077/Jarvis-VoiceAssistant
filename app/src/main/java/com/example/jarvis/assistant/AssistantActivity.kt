...
import bot.box.horology.annotation.DURATION.TODAY
...
import com.example.jarvis.data.AssistantDatabase
import com.example.jarvis.databinding.ActivityAssistantBinding
...
class AssistantActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textToSpeech = TextToSpeech(this) { status ->
            if (status == TextToSpeech.SUCCESS) {
                ...
                if (result == TextToSpeech.LANG_MISSING_DATA ||
                    ...
                    Log.e(logtts, "Intialization failed")
                }
            }
            ...
            speechRecognizer.setRecognitionListener(object : RecognitionListener {
                ...
                override fun onResults(bundle: Bundle) {
                    ...
                    if (data != null) {
                        ...
                        when {
                            keeper.contains("what is your name")->speak("Jarvis")
                            ...
                            keeper.contains("date") || keeper.contains("what is date") || keeper.contains("Today's date") -> getDate()
                            keeper.contains("time") || keeper.contains("what is time")-> getTime()
                            ...
                            keeper.contains("open Instagram") -> openInstagram()
                            keeper.contains("open Play Store") -> openPlayStore()
                            keeper.contains("open camera") -> openCamera()
                            keeper.contains("open gallery") -> openGallery()
                            keeper.contains("open Facebook") -> openFacebook()
                            keeper.contains("open messages") -> openMessages()
                            keeper.contains("open Gmail") || keeper.contains("Gmail")->openGmail()
                            keeper.contains("share a file") -> shareAFile()
                            keeper.contains("send a text message") -> shareATextMessage()
                            ...
                            keeper.contains("turn on Bluetooth") -> getAllPairedDevices()
                            ...
                            keeper.contains("medical") -> mediaApplication()
        ...
        private fun makeAPhoneCall(){
            val keeperSplit = keeper.replace(" ".toRegex(),"").split("o")
                .toTypedArray()
        ...
        private fun sendSMS(){
            ...
            if(ContextCompat.checkSelfPermission(
                ...
                val number = keeperReplaced.split("o").toTypedArray()[1].split("t")
                    .toTypedArray()[0]
        ...
        private fun openFacebook(){
            ...
            try {
                ...
                speak("Facebook is not installed")
            }
        }
        ...
        private fun openPlayStore(){
            ...
            try {
                ...
                speak("Play Store is not installed")
            }
        }
    ...
    private fun openGallery(){
        ...
        try {
            val intent = packageManager.getLaunchIntentForPackage("com.android.gallery")
            intent?.let { startActivity(it) }
        } catch (e: Exception){
            speak("Gallery is not installed")
        }
    }
        ...
        private fun capturePhoto(){
            if(ContextCompat.checkSelfPermission(
                ...
                speak("Photo will be saved to photos")
            }
        ...
        private fun setAlarm(){
             val intent = packageManager.getLaunchIntentForPackage(AlarmClock.ACTION_SET_ALARM)
            intent?.let { startActivity(it) }
        }
        private fun mediaApplication()
        {
                ...
                override fun onSuccess(currentWeather: CurrentWeather?){
                    speak(
                        """"
                            ...
                            City,Country: ${currentWeather!!.name},
